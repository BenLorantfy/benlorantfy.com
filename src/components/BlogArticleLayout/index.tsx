...
export function BlogArticleLayout(props: {
  slug: keyof typeof config.articles;
  markdown?: string;
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={config.articles[props.slug].description}
        />
        ...
        <meta
          name="image"
          property="og:image"
          content={convertToAbsoluteUrl(config.articles[props.slug].image.src)}
        />
        ...
        <meta
          name="twitter:title"
          content={config.articles[props.slug].title}
        />
        <meta
      ...
      <Nav />
      <div
        className="w-full m-auto min-h-full pl-8 pr-8"
