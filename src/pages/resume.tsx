...
const Resume: NextPage = () => {
    return (
        <>
            ...
            {/* <Nav /> */}
            <div className="m-auto min-h-full max-w-full print:w-full flex mt-16 print:mt-0" style={{ width: "8.5in", boxShadow: 'rgb(0 0 0 / 20%) 0px 3px 3px -2px, rgb(0 0 0 / 14%) 0px 3px 4px 0px, rgb(0 0 0 / 12%) 0px 1px 8px 0px' }}>
                <article className="p-[0.4in] w-1/3 bg-[#f0f5fc]">
                    <h1 id="main-header" className="text-[rgb(66,134,222)] text-4xl font-bold mb-8">Ben<br />Lorantfy</h1>
                    <section className='border-2 border-[rgb(66,134,222)] p-4 -mr-4 -ml-4'>
                        <h2 className="text-[rgb(66,134,222)] -mt-7 mb-1">
                            <span className="bg-[#f0f5fc] pl-1 pr-2">
                                Summary
                            </span>
                        </h2>
                        <ul>
                    ...
                    <section>
                        <h2 className="text-[rgb(66,134,222)] mt-8 mb-2">
                            Awards
                        </h2>
                    ...
                    <section>
                        ...
                        <a className='break-all text-xs text-[rgb(66,134,222)] underline' href="https://github.com/reduxjs/cra-template-redux">https://github.com/reduxjs/cra-template-redux</a>
                        <p className='mt-4'>cra-template-redux-typescript</p>
                        <a className='break-all text-xs text-[rgb(66,134,222)] underline' href="https://github.com/reduxjs/cra-template-redux-typescript">https://github.com/reduxjs/cra-template-redux-typescript</a>
                        <p className='mt-4'>redux-injectors</p>
                        <a className='break-all text-xs text-[rgb(66,134,222)] underline' href="https://github.com/react-boilerplate/redux-injectors">https://github.com/react-boilerplate/redux-injectors</a>
                        <div className='mt-4 hidden print:inline' />
                        <p className='mt-4'>DefinitelyTyped contributions</p>
                        <a className='break-all text-xs text-[rgb(66,134,222)] underline' href="https://github.com/DefinitelyTyped/DefinitelyTyped/pulls?q=is%3Apr+author%3ABenLorantfy">https://github.com/DefinitelyTyped/DefinitelyTyped/pulls?q=is%3Apr+author%3ABenLorantfy</a>
                    </section>
                </article>
                <main className="p-[0.4in] w-2/3" aria-labelledby='main-header'>
                    <h2 className='text-[rgb(66,134,222)] text-md font-bold mb-2'>Experience</h2>
                    <ExperienceEntry
                    ...
                    <p>Additional experience includes co-ops and early roles at SixFactors Inc. and Rivison Inc. <span className='text-sm text-slate-500'>(~7 mos)</span></p>
                    <Chip label='react' /><Chip label='angular' /><Chip label='cordova' />
                    <h2 className='text-[rgb(66,134,222)] text-md font-bold mt-8 mb-2'>Education</h2>
                    <h3 className='text-[rgb(66,134,222)] text-xl mb-1'>Software Engineering Tech. (B. Tech)</h3>
                    <div className={'text-lg mb-4'}>McMaster University, Hamilton, ON <span className='text-sm text-slate-500'>(2019 - 2024)</span></div>
                    <h3 className='text-[rgb(66,134,222)] text-xl mb-1'>Software Engineering Tech. (Adv. Diploma)</h3>
                    <div className={'text-lg'}>Conestoga College, Kitchener, ON <span className='text-sm text-slate-500'>(2013 - 2017)</span></div>
                </main>
            </div>
            {/* <Footer /> */}
        </>
...
function ExperienceEntry(props: {
    ...
    return (
        <div className="mb-8">
            <h3 className='text-[rgb(66,134,222)] text-xl mb-1'>{props.companyName}{props.domainName ? ` (${props.domainName})` : ""}</h3>
            <section>
                {props.positions.map((position, idx) => (
                    <>
                        {idx !== 0 && <ProgressLine />}
                        <div key={idx} className={clsx({ 'text-lg': idx === 0, 'mb-1': idx !== 0 })}><ProgressCircle /> {position.title} <span className='text-sm text-slate-500'>({position.startDate} - {position.endDate} · {position.duration})</span></div>
                    </>
                ))}
                    ...
                    {props.keyAccomplishments && (
                        <div className="bg-[#f0f5fc] p-4 mt-6 border border-[rgb(66,134,222)]">
                            <h4 className="-mt-7 font-bold">
                                <span className="inline-block origin-center rotate-2 bg-[#f0f5fc] pl-2 pr-2 pt-1 pb-1 border-2 border-[rgb(66,134,222)] text-[rgb(66,134,222)]">Key Accomplishments</span>
                            </h4>
